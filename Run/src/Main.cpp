...
int main() {
	...
	constexpr char LENA_ZOOM_SAVE1[] = "lena256_PGM_resizeNN.pgm";
	constexpr char LENA_ZOOM_SAVE2[] = "lena256_PGM_resizeBL.pgm";
	constexpr char LENA_ZOOM_SAVE3[] = "lena256_PGM_resizeBC.pgm";

	constexpr char SHUTTLE_ZOOM_SAVE1[] = "shuttle_pgm_resizeNN.pgm";
	constexpr char SHUTTLE_ZOOM_SAVE2[] = "shuttle_pgm_resizeBL.pgm";
	constexpr char SHUTTLE_ZOOM_SAVE3[] = "shuttle_pgm_resizeBC.pgm";
	...
	lena1.save(LENA_ZOOM_SAVE1, COMMENT);
	...
	shuttle1.save(SHUTTLE_ZOOM_SAVE1, COMMENT);
	...
	shuttle2.save(SHUTTLE_ZOOM_SAVE2, COMMENT);
	...
	shuttle3.save(SHUTTLE_ZOOM_SAVE3, COMMENT);
